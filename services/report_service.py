...
class ReportService:
    ...
    def get_sales_kpi(
        ...
        total_sales = metrics['total'] or Decimal('0.00')
        total_transactions = metrics['count'] or 0
        average_ticket = metrics['avg'] or Decimal('0.00')
        ...
        refunds_total = refunds['total'] or Decimal('0.00')
        ...
        if compare_previous:
            ...
            prev_total = prev_sales['total'] or Decimal('0.00')
    ...
    def get_employee_performance(
        ...
        return [
            EmployeePerformance(
                ...
                total_sales=emp['total'] or Decimal('0.00'),
                transactions=emp['count'] or 0,
                average_ticket=emp['avg'] or Decimal('0.00')
            )
    ...
    def get_hourly_sales(
        ...
        return [
            HourlySales(
                hour=h['hour'].hour,
                total_sales=h['total'] or Decimal('0.00'),
    ...
    def get_payment_method_breakdown(
        ...
        grand_total = sum(m['total'] or 0 for m in methods)
